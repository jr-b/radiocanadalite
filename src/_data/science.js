...
async function fetchNews() {
    ...
    fetch('https://services.radio-canada.ca/neuro/v1/lineups/4165?pagenumber=1'),
    fetch('https://services.radio-canada.ca/neuro/v1/lineups/4165?pagenumber=2')
    ]);

...
async function fetchNews() {
    ...
    fetch('https://services.radio-canada.ca/neuro/v1/lineups/771?pagenumber=1'),
    fetch('https://services.radio-canada.ca/neuro/v1/lineups/771?pagenumber=2')
    ]);
